...
import { sampleWithRequiredData } from '../noticias.test-samples';
...
describe('Noticias Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, NoticiasComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to noticiasService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getNoticiasIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getNoticiasIdentifier).toHaveBeenCalledWith(entity);
