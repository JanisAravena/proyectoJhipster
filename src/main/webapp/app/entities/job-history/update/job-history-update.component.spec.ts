...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 5447 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 27943 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 8409 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 4363 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 27125 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 16525 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 9113 };
      jobHistory.job = job;
      const department: IDepartment = { id: 9555 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 28348 };
      jobHistory.employee = employee;
