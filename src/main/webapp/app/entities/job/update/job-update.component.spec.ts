...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 5659 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 21475 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 5545 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 29343 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 30141 };
      job.tasks = [task];
      const employee: IEmployee = { id: 11756 };
      job.employee = employee;
